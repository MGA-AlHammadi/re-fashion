  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-orange-50 py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">KIDS</h1>
          <p className="text-gray-600 text-lg">Playful & Comfortable — nachhaltig für Kinder</p>
        </div>
        <SellButton />

        {products.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-24 h-24 bg-gradient-to-br from-yellow-100 to-orange-200 rounded-full flex items-center justify-center mb-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8">
            {products.map((p: any) => (
              <div key={p.id} className="group bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2">
                <div className="relative h-64 bg-gradient-to-br from-yellow-100 via-orange-100 to-yellow-200 overflow-hidden">
                  <img 
                ...
                <div className="p-5">
                  ...
                  <Link 
                    href={`/products/${p.id}`} 
                    className="block w-full text-center px-4 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl font-medium hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    Details ansehen
                  </Link>
                </div>
